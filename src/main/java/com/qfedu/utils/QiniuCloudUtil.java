...
public class QiniuCloudUtil {
    ...
    // 设置需要操作的账号的AK和SK
    private static final String ACCESS_KEY = "fWNyLmn5VOuj4A1NUT63neUAHO8gX_a5wDR1ob66";
    private static final String SECRET_KEY = "bTiTrO2dCG-t51X_UR_R2Hc8aL8eBE5UHdQJKZYu";

    // 要上传的空间
    private static final String bucketname = "yihuo-img";

    // 密钥
    private static final Auth auth = Auth.create(ACCESS_KEY, SECRET_KEY);

    private static final String DOMAIN = "pyxvf8fui.bkt.clouddn.com";
